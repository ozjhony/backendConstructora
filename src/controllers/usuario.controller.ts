...
export class UsuarioController {
  ...
  async create(
    ...
    //let idTipo = "607a19becdfb20143c1fe06d";
    let u = {
      nombre_usuario: usuariocreado.correo,
      telefono: usuariocreado.telefono,
      clave: claveCifrada,
      tipoUsuarioId: usuariocreado.tipo_usuario
    };

    await this.userlogRepository.create(u);
    ...
    if (usuariocreado) {
      this.servicioNotificaciones.enviarCorreoElectronico(usuariocreado.correo, llaves.origenCorreoElectronico, contenido);
    }

    // usuariocreado.user = user;
